...
class GroupResourceIT {
    ...
    public static Group createEntity(EntityManager em) {
        Group group = new Group().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return group;
    }
    ...
    public static Group createUpdatedEntity(EntityManager em) {
        Group group = new Group().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return group;
    }
    ...
    void putExistingGroup() throws Exception {
        ...
        updatedGroup.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateGroupWithPatch() throws Exception {
        ...
        partialUpdatedGroup.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
